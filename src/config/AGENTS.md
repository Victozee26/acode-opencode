...
- `settings.ts` — iframe scale, auto-start, and log-level setting constants: `SETTINGS_KEY_IFRAME_SCALE`, `DEFAULT_IFRAME_SCALE`, `IFRAME_SCALE_MIN`, `IFRAME_SCALE_MAX`, `IFRAME_SCALE_STEP`, `SETTINGS_KEY_AUTO_START`, `DEFAULT_AUTO_START`, `SETTINGS_KEY_LOG_LEVEL`, `DEFAULT_LOG_LEVEL`.
