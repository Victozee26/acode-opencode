...
- `src/opencode/AGENTS.md` — OpenCode lifecycle: install checks, installation, server start/stop/restart, health polling, update checking, runtime version diagnostics (node/npm for the error view).
